...
public class DelaunayNode
{
    ...
    public (Triangle t1, Triangle t2, Triangle t3, Triangle t4, DelaunayNode n1, DelaunayNode n2, DelaunayNode n3,
        DelaunayNode n4) Split(Vector3 p)
    {
        (DelaunayNode n, Triangle t) abc = (new DelaunayNode(p, Tetrahedra.a, Tetrahedra.b, Tetrahedra.c),
            new Triangle(Tetrahedra.a, Tetrahedra.b, Tetrahedra.c));
        (DelaunayNode n, Triangle t) bcd = (new DelaunayNode(p, Tetrahedra.b, Tetrahedra.c, Tetrahedra.d),
            new Triangle(Tetrahedra.b, Tetrahedra.c, Tetrahedra.d));
        (DelaunayNode n, Triangle t) cda = (new DelaunayNode(p, Tetrahedra.c, Tetrahedra.d, Tetrahedra.a),
            new Triangle(Tetrahedra.c, Tetrahedra.d, Tetrahedra.a));
        (DelaunayNode n, Triangle t) dab = (new DelaunayNode(p, Tetrahedra.d, Tetrahedra.a, Tetrahedra.b),
            new Triangle(Tetrahedra.d, Tetrahedra.a, Tetrahedra.b));
    ...
    public static (Triangle t1, Triangle t2, Triangle t3, Triangle t4, Triangle t5, Triangle t6, DelaunayNode n1,
        DelaunayNode n2, DelaunayNode n3)
        Flip23(DelaunayNode n1, DelaunayNode n2, Vector3 p1, Vector3 p2, Triangle t)
    {
        ...
        var t_ab_p1 = new Triangle(t.a, t.b, p1);
        n1.SetNeighbor(nab, t_ab_p1);
        var t_ab_p2 = new Triangle(t.a, t.b, p2);
        n2.SetNeighbor(nab, t_ab_p2);
        var t_bc_p1 = new Triangle(t.b, t.c, p1);
        n1.SetNeighbor(nbc, t_bc_p1);
        var t_bc_p2 = new Triangle(t.b, t.c, p2);
        n2.SetNeighbor(nbc, t_bc_p2);
        var t_ca_p1 = new Triangle(t.c, t.a, p1);
        n1.SetNeighbor(nca, t_ca_p1);
        var t_ca_p2 = new Triangle(t.c, t.a, p2);
        n2.SetNeighbor(nca, t_ca_p2);
        return (t_ab_p1, t_ab_p2, t_bc_p1, t_bc_p2, t_ca_p1, t_ca_p2, nab, nbc, nca);
    }

    public static (Triangle t1, Triangle t2, Triangle t3, Triangle t4, Triangle t5, Triangle t6, DelaunayNode n1,
        DelaunayNode n2)
        Flip32(DelaunayNode n1, DelaunayNode n2, DelaunayNode n3, Vector3 p31, Vector3 p12, Vector3 p23, Vector3 apex_x,
            Vector3 apex_y)
    {
        var a = p31;
        var b = p12;
